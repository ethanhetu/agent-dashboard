...
def agent_dashboard():
    ...
    for idx, (_, player) in enumerate(top_clients.iterrows()):
        with client_cols[idx]:
            ...
            if img_path:
                st.image(img_path, width=220, use_container_width=False)
            else:
                st.image("https://raw.githubusercontent.com/ethanhetu/agent-dashboard/main/headshots/placeholder.png", width=220)
