...
def project_definitions():
    ...
    st.markdown("""
    - **Dollar Index**: The key metric of the project. The Dollar Index is simple: for every dollar of on-ice value delivered by a client to his team, how many dollars is the agent delivering to his client? A Dollar Index of $0.75 means an agent is successfully capturing 75 cents for every dollar his client is delivering on the ice.
